...
import com.tnoffapps.screensetadmin.R;

import java.util.HashMap;

public class activity_edit_profile_page extends AppCompatActivity {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    try {
                        Glide.with(activity_edit_profile_page.this).load(image).into(set);
                    } catch (Exception e) {
                    }
                }
            }
        ...
        editpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(oldp)) {
                    Toast.makeText(activity_edit_profile_page.this, "Current Password cant be empty", Toast.LENGTH_LONG).show();
                    return;
                }
                if (TextUtils.isEmpty(newp)) {
                    Toast.makeText(activity_edit_profile_page.this, "New Password cant be empty", Toast.LENGTH_LONG).show();
                    return;
                }
                dialog.dismiss();
                    ...
                    public void onSuccess(Void aVoid) {
                        user.updatePassword(newp)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        pd.dismiss();
                                        Toast.makeText(activity_edit_profile_page.this, "Changed Password", Toast.LENGTH_LONG).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                pd.dismiss();
                                Toast.makeText(activity_edit_profile_page.this, "Failed", Toast.LENGTH_LONG).show();
                            }
                        });
                    }
                }).addOnFailureListener(new OnFailureListener() {
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    databaseReference.child(firebaseUser.getUid()).updateChildren(result).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(activity_edit_profile_page.this, " updated ", Toast.LENGTH_LONG).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(activity_edit_profile_page.this, "Unable to update", Toast.LENGTH_LONG).show();
                        }
                    });
                    if (key.equals("name")) {
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        Log.w("Filepathname ", filepathname);
        ...
        storageReference1.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                if (uriTask.isSuccessful()) {
                    Log.w("Was able to convert image to URL!", "CONVERTED");
                    ...
                    databaseReference.child(firebaseUser.getUid()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(activity_edit_profile_page.this, "Error Updating ", Toast.LENGTH_LONG).show();
                            Log.w("VERY BIG ERROR", "THE URI PROCESS HAS BEEN CAUGHT AS A FAILURE.");
                        }
                    });
                } else {
                    pd.dismiss();
                    Toast.makeText(activity_edit_profile_page.this, "Error", Toast.LENGTH_LONG).show();
                    //Log.w("VERY BIG ERROR", "Crap didnt even catch an error");
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(activity_edit_profile_page.this, "Error", Toast.LENGTH_LONG).show();
                Log.w("VERY BIG ERROR", "Line 497 an error was caught.");
            }
        });
    }
